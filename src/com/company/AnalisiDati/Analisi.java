...
public class Analisi {
    ...
    public static Double mean(ZZList<Double> list) {
        return list.fold(0.0, (acc, elem) -> acc + elem) / list.size();
    }
    ...
    public static Double varianza(ZZList<Double> list) {
        return mean(list.map(e -> e * e)) - Math.pow(mean(list), 2.0);
    }
    ...
    public static void bootstrap(ZZList<Double> list, int b) {
        ...
        matrix.fold(stime, (acc, elem) -> acc.insertTail(mean(elem)));
